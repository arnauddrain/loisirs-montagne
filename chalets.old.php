	...
	<div class="container chalets">
		<article class="col-12">
			...
			<?php 
				...
				// echo $precedent;
				$rq_galerie = "SELECT * FROM t_galerie ORDER BY id_img LIMIT $debut,$nombre ";
					 ...
					 <div class="bg_suivant col-12	">
						 <div class="suivant col-6">
						 	<?php 
						 	 ...
						 	 ?>
						 	 <div class="col-6">
						 		<a  class="nope" href="chalets.php?debut=<?php echo $precedent; ?>&#galerie_photo">précédent</a>
						 	</div>
						 	<?php 
						 	 ...
						 	 ?>
						 	 <div class="col-6">
							 	<a  class="nope" href="chalets.php?debut=<?php echo $suivant; ?>&#galerie_photo">suivant</a>
							 </div>
							 <?php 
							 	}
							  ?>
